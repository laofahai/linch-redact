        ...
        <div className="space-y-1">
          {files.map((file) => (
            <div
              key={file.id}
              className={cn(
                "group flex w-full min-w-0 cursor-pointer items-center gap-2 overflow-hidden rounded-md px-2 py-1.5 text-sm transition-colors",
            ...
            >
              ...
              <span className="block flex-1 min-w-0 truncate">{file.name}</span>
              <Button
                variant="ghost"
                size="icon"
